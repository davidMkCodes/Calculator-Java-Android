...
//FIX: - AFTER PRESSING SQUARE, SQUAREROOT, ETC AND THEN EQUAL. ERROR
public class MainActivity extends AppCompatActivity {
    ...
    public static ArrayList<String> calculationList = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn0.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(operatorToExecute == "="){             //if num 0-9 is selected after selecting
        ...
        btnPlusMinus.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if(currentNum.length() > 0){     //if NOT negative & user has entered an input
        ...
        btnHistory.setOnClickListener(new OnClickListener() {  //open pop-up of calculation history
            @Override
            public void onClick(View v) {
                openHistory();
        ...
        btnClearEntry.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        btnSquareRoot.setOnClickListener(new OnClickListener() {        //SQUARE ROOT
            @Override
            public void onClick(View v) {
        ...
        btnSquare.setOnClickListener(new OnClickListener() {            //SQUARE
            @Override
            public void onClick(View v) {
                try {
        ...
        btnDivideByX.setOnClickListener(new OnClickListener() {         //1/ CURRENT NUM
            @Override
            public void onClick(View v) {
                try {
                    if(currentNum.length() == 0) currentNum = "0";
        ...
        btnPercent.setOnClickListener(new OnClickListener() {           //CURRENTNUM / 100
            @Override
            public void onClick(View v) {
                try {
                    if(currentNum.length() == 0) currentNum = "0";
        ...
        btnEquals.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if(previousOperator != "=" && operatorToExecute == "=") {
        ...
        btnAdd.setOnClickListener(new OnClickListener() {   //add
            @Override
            public void onClick(View v) {
        ...
        btnSubtract.setOnClickListener(new OnClickListener() {  //subtract
            @Override
            public void onClick(View v) {
                if(consecutiveEqual) consecutiveEqual = false;
        ...
        btnMultiply.setOnClickListener(new OnClickListener() {     //multiply
            @Override
            public void onClick(View v) {
                if(consecutiveEqual) consecutiveEqual = false;
                compute("x");
        ...
        btnDivide.setOnClickListener(new OnClickListener() {    //divide
            @Override
            public void onClick(View v) {
                if(consecutiveEqual) consecutiveEqual = false;
                compute("/");
    ...
    public void compute(String nextOperator){
        try {
            ...
            if(num1 == Double.POSITIVE_INFINITY ){          //if only one number has been entered
                ...
                if (operatorToExecute.equals("+")) {
                    num1 += num2;
                } else if (operatorToExecute.equals("-")) {
                    num1 -= num2;
                } else if (operatorToExecute.equals("x"))
                    num1 *= num2;
                else if (operatorToExecute.equals("/"))
                    num1 /= num2;

                if(nextOperator != "="){        //formatting current equation for calculation history
                ...
                if(operatorToExecute != "=") calculationList.add(0,equation);

                if(num1 > Integer.MAX_VALUE || currentNum.length() > 9)     //if the total from calculation
                    display1.setText(String.valueOf(f.format(num1)));       //exceeds max value of an int OR
