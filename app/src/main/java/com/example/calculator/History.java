...
public class History extends AppCompatActivity {
    ArrayList<String> calculationsList = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clear.setOnClickListener(new View.OnClickListener() {           //clear calculation history and
            @Override                                                   //display empty page
